...
admin.editZixun = function(ids) {
    location.href = U('admin/Topic/editor')+'&ids='+ids;
};
admin.Zixuntj= function(ids,type,obj) {
    $.get(U('admin/Topic/ajaxtj'),{type:type,ids:ids},function(res){
        $(obj).html(res)
    })
};
//添加标签
