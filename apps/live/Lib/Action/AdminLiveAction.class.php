...
//            }
            ...
            if($_GET['crow_id']){ //众筹课程
                ...
                $this->pageKeyList   = array('video_title','live_cate','mhm_id','teacher_id','cover','video_binfo','video_intro','vip_level','str_tag','video_score',
    ...
    public function editLive(){
        if( isset($_POST) ) {
            ...
            $this->pageKeyList   = array('id','video_title','live_cate','mhm_id','teacher_id','cover','video_binfo','video_intro','vip_level','str_tag','video_score',
