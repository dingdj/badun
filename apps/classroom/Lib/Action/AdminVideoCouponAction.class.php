...
/**
    ...
    public function index(){
        ...
        foreach($listData['data'] as $key=>$val){
            ...
            $val['DOACTION'].=" | <a href=".U('classroom/AdminVideoCoupon/addCoupon',array('id'=>$val['id'],'tabHash'=>'revise')).";>修改</a>";
     ...
     * Enter description here ...
     */
    public function couponMaxPriceSys(){
        $this->_initTabSpecial();
        $this->assign('pageTitle','优惠满减最低设置');

        $this->pageKeyList = array ( 'max_price_sys');
        $this->notEmpty = array ( 'max_price_sys');
