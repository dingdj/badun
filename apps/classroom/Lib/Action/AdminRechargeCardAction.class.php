...
class AdminRechargeCardAction extends AdministratorAction{
...
/**
    ...
    private function _initTabSpecial() {
        ...
        $this->pageTab [] = array (
                'title' => '充值卡列表',
                'tabHash' => 'index',
                'url' => U ( 'classroom/AdminRechargeCard/index' )
        );
        $this->pageTab [] = array (
                'title' => '添加充值卡',
                'tabHash' => 'addTeacher',
                'url' => U ( 'classroom/AdminRechargeCard/addRecharge' )
        );
    }
    ...
    public function index(){
        ...
        foreach($listData['data'] as $key=>$val){
            ...
            $val['DOACTION'].=" | <a href=".U('classroom/AdminRechargeCard/addRecharge',array('id'=>$val['id'],'tabHash'=>'revise')).";>修改</a>";
    ...
    public function addRecharge(){
        ...
        if($id){
            $this->savePostUrl = U ( 'classroom/AdminRechargeCard/doAddRecharge','type=save&id='.$id);
            ...
            $this->savePostUrl = U ('classroom/AdminRechargeCard/doAddRecharge','type=add');
