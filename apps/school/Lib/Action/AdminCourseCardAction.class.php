...
/**
    ...
    private function _initTabSpecial() {
        ...
        $this->pageTab [] = array (
                'title' => '课程卡列表',
                'tabHash' => 'index',
                'url' => U ( 'school/AdminCourseCard/index' )
        );
        $this->pageTab [] = array (
                'title' => '添加课程卡',
                'tabHash' => 'addCoupon',
                'url' => U ( 'school/AdminCourseCard/addCoupon' )
        );
    }
    ...
    public function index(){
        ...
        $map = array('type'=>5,'coupon_type'=>0,'sid'=>$this->school_id);
        ...
        foreach($listData['data'] as $key=>$val){
            ...
            if($val['video_type'] == 1){
                ...
                $url = U('school/Video/view', array('id' => $val['video_id']));
            ...
            $val['DOACTION'].=" | <a href=".U('school/AdminCourseCard/addCoupon',array('id'=>$val['id'],'tabHash'=>'revise')).";>修改</a>";
